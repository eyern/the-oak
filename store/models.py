...
class PostImage(models.Model):
    post = models.ForeignKey(Product, verbose_name="Product", on_delete=models.CASCADE)
    image = models.ImageField(upload_to='product', blank=True, null=True, verbose_name="Post Image")
